 ...
 * Handles user creation, validation, password hashing, and event publishing.
 */
@Service
public class UserServiceImpl implements UserService {
     ...
     * - Validates that all required fields (first name, last name, email, and password) are provided
     * - Hashes the user's password using a utility class
     * - Saves the user to the repository
     * - Publishes a {@link UserConfirmationEvent} to notify about the creation of the user
     *
     * @param user the user object to be created
     * @throws InvalidUserException if any required field is missing or invalid
     */
    @Transactional
    @Override
