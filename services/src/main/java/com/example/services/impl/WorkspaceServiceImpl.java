...
public class WorkspaceServiceImpl implements WorkspaceService {
    ...
    /**
     * Creates a new workspace after validating required fields.
     * This method performs the following tasks:
     * - Validates that the workspace type is provided
     * - Validates that the workspace price is greater than zero
     * - Saves the workspace to the repository
     * - Publishes a {@link WorkspaceConfitmationEvent} to notify about the creation of the workspace
     *
     * @param workspace the workspace object to be created
     * @throws InvalidWorkspaceException if any required field (type or price) is invalid
     */
    @Transactional
    @Override
